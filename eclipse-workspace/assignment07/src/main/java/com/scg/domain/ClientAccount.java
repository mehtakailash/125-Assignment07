...
public class ClientAccount implements Account, Comparable<ClientAccount> , Serializable{
	...
	private static final long serialVersionUID = 1200412490472815307L;
...
//		Overrides Object.hashCode. This override is required because the class overrides Object.equals.
	...
	/**
	 * Returns client name.TimeEntryList
	 * @return name
	 */
	@Override
...
//		Overrides Object.toString. Returns the client name
	...
	public int compareTo( ClientAccount other ) {
		int comparrissionValue = Comparator.comparing( ClientAccount::getName)
