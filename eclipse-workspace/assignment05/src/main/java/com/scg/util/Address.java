...
public class Address implements Comparable<Address>, Serializable {
	...
	private static final long serialVersionUID = -9053449145301331554L;
	/** The street address. */
     ...
     */
    public boolean testObjectEquality( Object obj1, Object obj2 )
    {
        boolean rcode   = false;
    ...
    public int compareTo( Address other ) {
		int comparrissionValue = Comparator.comparing( Address::getState)
