...
public final class Assignment05 {
    ...
    private static final Month INVOICE_MONTH =Month.APRIL;

    /** The test year. */
    private static final int INVOICE_YEAR = 2004;
...
//        LocalDate startDate = LocalDate.of(INVOICE_YEAR,INVOICE_MONTH,01);
//        LocalDate endDate = LocalDate.of(INVOICE_YEAR,INVOICE_MONTH,startDate.lengthOfMonth());
